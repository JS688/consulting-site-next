      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center text-center">
        ...
        <div className="max-w-5xl pt-2 pb-2">
          ...
          <p className="text-gray-300 mt-2 text-sm md:text-base font-light opacity-80">
            AI‑powered custom‑coded websites. Unique logos & animations. Built from scratch<span className="align-super text-[0.7em]">TM</span>
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 max-w-4xl">
          <div className="rounded-2xl border-2 border-[rgb(245,197,24)] bg-black px-8 py-12 text-center shadow-[0_0_30px_rgba(245,197,24,0.15)]">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Link
                href="/contact"
                className="inline-flex min-w-[200px] items-center justify-center rounded-full bg-[rgb(245,197,24)] px-6 py-3 text-sm font-semibold text-black transition hover:opacity-90"
              >
                Start a Project
              </Link>
              ...
              {approachSteps.map((step, index) => (
                <div key={step.number} className="relative flex flex-1 flex-col justify-center">
                  ...
                  {index < approachSteps.length - 1 && (
                    <div className="absolute top-1/2 right-[-32px] z-20 flex -translate-y-1/2 items-center">
