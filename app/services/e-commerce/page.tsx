          ...
          <div className="group relative rounded-2xl p-[1px] transition duration-300">
            ...
            <div className="relative z-10 flex flex-col rounded-2xl border border-[#d1b075]/30 bg-zinc-950/70 p-8 shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out hover:border-[#d1b075]/60 hover:bg-zinc-950/85 hover:shadow-[0_0_35px_rgba(209,176,117,0.18)]">
              ...
              <div className="mt-4 mb-1 flex items-center gap-2">
                <ShoppingCart className="mt-1 h-6 w-6 shrink-0 text-[#d1b075]" />
                <h1 className="text-xl font-semibold text-white md:text-2xl">
                  E-Commerce Websites (Online Stores)
                </h1>
              </div>

              <div className="mt-4 text-gray-100 text-[15px] leading-7">
              ...
              <div className="mt-3 text-xs text-white/50 tracking-wide text-center">
              ...
              <div className="mt-4 text-[15px] leading-7 text-white/70">
                Conversion-focused design tuned for higher trust and repeat purchases.
                Built with organized product architecture, seamless checkout flow, and
                room to grow as your catalog expands.
              </div>
