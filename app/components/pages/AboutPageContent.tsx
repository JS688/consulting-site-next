...
const copy = {
  en: {
    titleStart: "For those who expect",
    titleAccent: "more",
    paragraphs: [
    ...
    closing: "Built to perform. Designed to bring in customers.",
  },
  es: {
    titleStart: "Para quienes esperan",
    titleAccent: "mas",
    paragraphs: [
      "No solo disenamos sitios web — construimos sistemas de visibilidad.",
      "Cada proyecto empieza entendiendo como buscan tus clientes y que necesita tu negocio para ser encontrado.",
      "Creamos sitios web claros, estructurados y hechos para rendir en Google y en los entornos de busqueda modernos.",
      "Y seguimos mejorandolos a medida que tu negocio crece.",
    ],
    closing: "Construido para rendir. Disenado para atraer clientes.",
  },
} as const;
    ...
    <>
      <section className="relative min-h-[80vh] overflow-hidden bg-linear-to-b from-[#0b0b0b] via-[#121212] to-black px-6 py-24 text-white">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-center text-center">
          ...
          >
            {localized.titleStart}{" "}
            <span className="relative inline-block">
              <span className="text-yellow-400">{localized.titleAccent}</span>
