    ...
    <main className="min-h-screen bg-[#04060c] px-6 py-20 text-white">
      <div className="mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center text-center">
        ...
        <h1 className="mt-5 text-4xl font-bold tracking-tight text-[#e6c26a] sm:text-5xl">
          Opening your booking page next.
        </h1>
        <p className="mt-5 max-w-xl text-base leading-7 text-white/60 sm:text-lg">
          Thank you. Your payment is complete and we&apos;re sending you to the booking page now.
        </p>

        {sessionId ? (
          <p className="mt-6 text-sm text-white/40">Session: {sessionId}</p>
        ) : null}
        ...
        <Link
          href="/"
          className="mt-5 text-sm text-white/45 transition hover:text-white"
        >
          Back to JulTech
        </Link>
      </div>
