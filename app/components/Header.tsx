    ...
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-zinc-900 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
          ...
          >
            <div className="flex flex-col justify-center leading-tight">
              <div className="flex items-center gap-1">
                <span className="text-[rgb(245,197,24)] font-semibold text-[1.35rem] tracking-wider drop-shadow-[0_0_10px_rgba(245,197,24,0.42)] transition-[filter] duration-200 group-hover:drop-shadow-[0_0_12px_rgba(245,197,24,0.46)]">
                  Jul
                </span>
                <span className="text-white font-bold text-[1.35rem] tracking-wider drop-shadow-[0_0_3px_rgba(255,255,255,0.12)] transition-[filter] duration-200 group-hover:drop-shadow-[0_0_5px_rgba(255,255,255,0.16)]">
                  Tech
                </span>
                <span className="ml-1 inline-flex items-center rounded-full border border-[rgb(245,197,24)]/40 bg-[rgb(245,197,24)]/12 px-1.5 py-px text-[10px] font-bold uppercase tracking-[0.24em] text-[rgb(245,197,24)] shadow-[0_0_14px_rgba(245,197,24,0.28)] drop-shadow-[0_0_4px_rgba(255,255,255,0.3)] transition-[filter,box-shadow] duration-200 group-hover:shadow-[0_0_16px_rgba(245,197,24,0.34)]">
                  AI
                </span>
              </div>
          ...
          {/* DESKTOP NAV */}
          <nav className="hidden translate-y-0.5 md:flex items-center gap-8 text-base">
            <a
              href="/about"
