    ...
    <div className="min-h-screen bg-zinc-900 text-white">
      <div className="min-h-screen px-6 py-8 md:py-10">
        <div className="mx-auto max-w-3xl pt-6 pb-6">
          <Link
            href="/services"
            className="inline-flex items-center gap-1 text-sm text-[#d1b075]/70 transition hover:text-[#d1b075] mb-8"
          >
            ← Back to Services
          </Link>
          ...
          <div className="group relative rounded-2xl p-px transition duration-300">
            ...
            <div className="relative z-10 flex flex-col rounded-2xl border border-[#d1b075]/30 bg-zinc-950/70 p-8 shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out hover:border-[#d1b075]/60 hover:bg-zinc-950/85 hover:shadow-[0_0_35px_rgba(209,176,117,0.18)]">
              ...
              <div className="mt-4 mb-1 flex items-center gap-2">
                <span className="mt-1 text-[#d1b075] text-2xl leading-none">✦</span>
                <h1 className="text-xl font-semibold text-white md:text-2xl">
                  Portfolio Websites
                </h1>
              </div>

              <div className="mt-4 text-sm leading-7 text-gray-100 whitespace-nowrap">
                Custom‑coded portfolios built to showcase your work
              </div>

              <div className="mt-3 text-xs text-white/70">
                Strong storytelling · Smooth motion · Branded visuals
              </div>

              <div className="mt-3 text-xs tracking-wide text-center text-white/50">
